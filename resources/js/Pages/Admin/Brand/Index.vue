...
<template>
    <AdminLayout title="Brands" subtitle="Manage product brands">
        ...
        <!-- Search -->
        <div
            class="grid grid-cols-1 mb-4 bg-white p-2 rounded-3xl border-slate-100 shadow-sm w-full md:w-1/3"
        >
            <div class="relative">
                <input
                    v-model="searchName"
                    ...
                    class="w-full pl-4 pr-4 py-1.5 bg-slate-50 border border-slate-100 rounded-full text-xs focus:ring-4 focus:ring-green-500/10 focus:border-green-400 focus:bg-white outline-none transition-all placeholder:text-slate-400"
                />
            </div>
        </div>
        ...
        >
                    ...
                    >
                        <td class="px-6 py-4">
                            <div class="flex items-center gap-3">
                                <div
                                    class="w-10 h-10 rounded-lg bg-gray-100 flex items-center justify-center overflow-hidden border border-gray-200"
                                >
                                    <img
                                        v-if="brand.image"
                                        :src="brand.image"
                        ...
                        <td
                            class="px-6 py-4 text-sm font-semibold text-slate-700"
                        >
            ...
            <div
                v-if="brands.links"
                class="p-3 border-t border-slate-100 flex justify-center gap-1"
            >
                <!-- Simple buttons for prev/next based on your paginator structure -->
                <button
                    v-for="(link, i) in brands.links"
                    :key="i"
        ...
        <Transition name="modal-fade">
            ...
            >
                ...
                <div
                    class="relative bg-white w-full max-w-5xl rounded-[2rem] shadow-2xl overflow-hidden animate-pop"
                >
                    <div
                        class="bg-white px-8 py-6 border-b border-slate-100 flex justify-between items-center"
                    >
                        <div class="text-left">
                            <h2
                    ...
                    <div class="p-8 space-y-4">
                        ...
                        <div class="flex justify-center mb-4">
                            <div
                                class="relative w-24 h-24 rounded-2xl bg-slate-50 border-2 border-dashed border-slate-200 flex items-center justify-center overflow-hidden group cursor-pointer"
                            ...
                            >
                                ...
                                >
                                <div
                                    class="absolute inset-0 bg-black/20 hidden group-hover:flex items-center justify-center text-white text-xs"
                                >
                                    Change
                                </div>
                            </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div class="space-y-1">
                                ...
                                <input
                                    v-model="form.name"
                                    placeholder="Name"
                                    class="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-2xl focus:ring-4 focus:ring-green-500/10 focus:border-green-400 outline-none transition-all"
                                />
                                <p
                            ...
                            <div class="space-y-1">
                                ...
                                <select
                                    v-model="form.status"
                                    class="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-2xl outline-none appearance-none cursor-pointer"
                                >
